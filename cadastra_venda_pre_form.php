        ...
        <center>
            ...
            <div class="panel panel-default corpo">
                ...
                <div class="panel-body">
                    ...
                    <form action="php/cadastra_venda_pre_mec.php" method="post" class="form form-inline" >
                        ...
                        <div class="item">
                            ...
                            <br />
                            <input class="form-control" type="text" name="nop" style="width: 250px" value="VENDA">
                        </div>
                        <div class="item">
                        ...
                        <div class="item">
                            ...
                            <br />
                            <input class="form-control" type="text" name="data_emis" value="<?php echo date("d/m/Y") ?>" style="width: 100px" />
                        </div>
                        <div class="item">
                            <span class="item_titulo">Data Estrada/Saída: </span>
                            <br />
                            <input class="form-control" type="text" name="data_saida_entrada" value="<?php echo date("d/m/Y") ?>" style="width: 100px" />
                        </div>
                        <div class="item">
