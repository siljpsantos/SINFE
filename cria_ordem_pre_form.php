                                    ...
                                    <td style="padding: 0px 5px;  height: 400px">
                                        <div>
                                            <table id="servico">
                                                ...
                                                <tr>
                                                    <td>
                                                        <input type="checkbox" name="n_aprov_yn" value="1" /> N/ Aprov.
                                                    </td>
                                                </tr>
                                            </table>
                                        </div>
                                        ...
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        <input name="data_abertura" type="text" value="<?php echo date('d/m/Y') ?>" />
                                        <br />
                                        <br />
                                        ...
                                        &nbsp;&nbsp;
                                        <input name="data_fechamento" type="text" value="<?php echo date('d/m/Y') ?>" />
                                        <br />
                                        <br />
                                        <font color=dark-orange>Horário:</font>
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        <input name="hora_fechamento" type="text" value="<?php echo date('H:i:s') ?>" />
                                        <br />
                                        <br />
                                        Valor a Pagar: R$ <input type="text" name="val_a_pg" style="width: 150px; float: right" />
                                        <br />
                                        <br />
