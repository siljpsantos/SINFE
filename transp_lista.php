  ...
  <?php include "menu_links.php";?>
   ...
   <script src="//ajax.googleapis.com/ajax/libs/jquery/2.0.0/jquery.min.js"></script>
    ...
    <section id="cadastro">
		...
		<center>
			<div class="panel panel-default corpo">
				...
				<div class="panel-body">
			    	<form action="transp_lista.php" method="post" class="form form-inline" style="display: inline-block">
			       	<div id="search">
			       		<span>
			       			Pesquisa por cnpj da Transportadora:
			       		</span>
			       		<input class="form-control" type="text" name="cnpj" id="pesquisa_2" placeholder="Pesquisa de ordens" autofocus />
        ...
        <center>
            <span>
                <a class="btn btn-sinfe-1 btn-block" style="width: 1200px" href="cadastra_transp_form.php" class="interno">Cadastrar Transportadora</a>
            </span>	
        </center>
