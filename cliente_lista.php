<?php
	...
	if(isset($_POST['nome']) && $_POST['nome'] != NULL){
		$cliente = cliente_nome($pdo,$_POST['nome']); //seleciona clientes por nome
	}else {
  ...
  <?php include "menu_links.php";?>
   ...
   <script src="//ajax.googleapis.com/ajax/libs/jquery/2.0.0/jquery.min.js"></script>
    ...
    <section id="cadastro">
    	...
    	<center>
			<div class="panel panel-default corpo">
				...
				<div class="panel-body">
			    	<form action="cliente_lista.php" method="post" class="form form-inline" style="display: inline-block">
			       	<div id="search">
			       		<span>
			       			Pesquisa por nome do cliente:
			       		</span>
			       		<input class="form-control" type="text" name="nome" id="pesquisa_2" placeholder="Pesquisa de clientes" autofocus />
        ...
        <center>
            <span>
                <a class="btn btn-sinfe-1 btn-block" href="cadastra_cliente_form.php" style="width: 1200px">Cadastrar Cliente</a>
            </span>
        </center>
