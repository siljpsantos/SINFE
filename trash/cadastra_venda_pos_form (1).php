                                ...
                                <table id="lista">
                                    ...
                                    <?php 
                                        ...
                                        <tr id="lista_content">
                                            ...
                                            <td>
                                                <?php echo $key['val_desc_unit_item'] ?>
                                            </td>
                                            <td>
                                                <?php echo $key['val_desc_item']."%" ?>
                                            </td>
                                            <td>
                    ...
                    <div class="panel-body">
                        ...
                        <article id="itens" style="height:auto !important;">
                            ...
                            <div class="item" style="padding-top: 12px;">
                                ...
                                -->
                                <input type="text" class="form-control" autofocus style="width: 700px" name="id_produto" />
                            </div>
                            <div class="item">
    		...
    		<form class="form form-inline" id="info" method="post">
                ...
                <!-- botoes -->
                 <div style="padding-left: 10px">
                    ...
                    <button class="btn btn-default" onclick="location.reload();" name="id">Novo Produto - F5</button>
                    <button id="pg_btn" class="btn btn-default" onclick="$('#modal_pg').click();" name="id">Pagamento - F8</button>
                            ...
                            <div>
                                <!-- <form id="info_dest" method="post"> -->
                                    ...
                                    <div class="item">
                                        ...
                                        <br />
                                        <input class="form-control" type="text" name="nome_avulso" style="width: 1140px; min-width: 400px;">
                                    </div>
                                    <div id="div_dest">
                                        <div class="item">
                                        ...
                                        <div class="item">
                                            ...
                                            <br />
                                            <input class="form-control" value="<?php if($cliente_n){echo $cliente_nfe[0]['cpf_cnpj_cliente'];} ?>" type="text" name="cpf_cnpj" style="width: 150px; min-width: 100px;" />
                                        </div>
                                        <div class="item">
                    ...
                    <div class="modal-body">
                      <form class="form form-inline" id="info_pg" action="" method="post">
                            ...
                            <div class="item">
                                ...
                                <br />
                                <input class="form-control" value="<?php if($venda[0]['val_pg_nfe']!='0.00'){echo $venda[0]['val_pg_nfe'];} ?>" name="val_pg" type="text" style="width: 120px" />
                            </div>
                            <div class="item">
