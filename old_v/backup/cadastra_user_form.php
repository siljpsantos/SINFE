    	...
    	<form action="php/cadastra_user_mec.php" method="post" style="display: inline-block">
    		...
    		<p/>
	       	<div id="login">
	       		...
	       		<div style="display: inline-block">
	       			<input required type="text" name="nome" style="width: 280px" placeholder="Primeiro e último nomes do usuário" autofocus required/>
	       			<br />
	       			<input required type="text" name="login" style="width: 280px" placeholder="nick que será usado para logar-se ao Sistema" required/>
	       			<br />
	       			<input required type="password" name="senha" style="width: 280px" placeholder="Senha do usuário" required/>
	       			<br />
	       			<br />
	       			<input required type="password" name="master" style="width: 280px" placeholder="Senha master" required/>
	       		</div>
	       	</div>
	   		<br />
