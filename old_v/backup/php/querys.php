<?php
	...
	function login($pdo,$login,$senha){
		...
		$select = $pdo->query("SELECT * FROM tab_adm WHERE login_adm = '".$login."' AND senha_adm = '".$senha."' ");
	...
	function add_cliente($pdo,$info){
		...
		try{
			...
			$prepara->bindParam(1, $_POST['status'], PDO::PARAM_INT );
			$prepara->bindParam(2, $_POST['nome/razao_social'], PDO::PARAM_INT );
			$prepara->bindParam(3, $_POST['cpf/cnpj'], PDO::PARAM_INT );
			$prepara->bindParam(4, $_POST['inscricao_estadual'], PDO::PARAM_INT );
			$prepara->bindParam(5, $icms, PDO::PARAM_INT );
			$prepara->bindParam(6, $_POST['suframa'], PDO::PARAM_INT );
			$prepara->bindParam(7, $_POST['email'], PDO::PARAM_INT );
			$prepara->bindParam(8, $_POST['banco'], PDO::PARAM_INT );
			$prepara->bindParam(9, $_POST['agencia'], PDO::PARAM_INT );
			$prepara->bindParam(10, $_POST['conta'], PDO::PARAM_INT );
			$prepara->bindParam(11, $_POST['logradouro'], PDO::PARAM_INT );
			$prepara->bindParam(12, $_POST['numero'], PDO::PARAM_INT );
			$prepara->bindParam(13, $_POST['complemento'], PDO::PARAM_INT );
			$prepara->bindParam(14, $_POST['bairro'], PDO::PARAM_INT );
			$prepara->bindParam(15, $_POST['cep'], PDO::PARAM_INT );
			$prepara->bindParam(16, $_POST['pais'], PDO::PARAM_INT );
			$prepara->bindParam(17, $_POST['uf'], PDO::PARAM_INT );
			$prepara->bindParam(18, $info['municipio'], PDO::PARAM_INT );
			$prepara->bindParam(19, $info['cod_municipio'], PDO::PARAM_INT );
			$prepara->bindParam(20, $_POST['telefone'], PDO::PARAM_INT );
			$prepara->bindParam(21, $_POST['celular'], PDO::PARAM_INT );
			$prepara->bindParam(22, $_POST['nome_contato'], PDO::PARAM_INT );
			$prepara->bindParam(23, $_POST['telefone_contato'], PDO::PARAM_INT );
			$prepara->bindParam(24, $_POST['email_contato'], PDO::PARAM_INT );
	...
	function edita_cliente($pdo,$info){
		...
		try{
			...
			$prepara->bindParam(23, $_POST['telefone_contato'], PDO::PARAM_INT );
			$prepara->bindParam(24, $_POST['email_contato'], PDO::PARAM_INT );
			$prepara->bindParam(25, $_POST['id'], PDO::PARAM_INT );
	...
	function edita_produto($pdo,$info){
		...
		try{
			...
			$prepara->bindParam(6, $info['classe_ipi'], PDO::PARAM_INT );
			$prepara->bindParam(7, $info['cod_enquadr_ipi'], PDO::PARAM_INT );
			$prepara->bindParam(8, $info['id'], PDO::PARAM_INT );
	...
	function add_ordem($pdo,$info){
		...
		try{
			...
			$prepara->bindParam(5, $info['equip'], PDO::PARAM_INT );
			$prepara->bindParam(6, $info['serie_equip'], PDO::PARAM_INT );
			$prepara->bindParam(7, $info['garantia_yn'], PDO::PARAM_INT );
			$prepara->bindParam(8, $info['contrato_yn'], PDO::PARAM_INT );
			$prepara->bindParam(9, $info['avulso_yn'], PDO::PARAM_INT );
			$prepara->bindParam(10, $info['inviavel_yn'], PDO::PARAM_INT );
			$prepara->bindParam(11, $info['sem_conserto_yn'], PDO::PARAM_INT );
			$prepara->bindParam(12, $info['garantia_ate'], PDO::PARAM_INT );
			$prepara->bindParam(13, $info['val_pg'], PDO::PARAM_INT );
			$prepara->bindParam(14, $info['forma_pg'], PDO::PARAM_INT );
			$prepara->bindParam(15, $info['conserto_yn'], PDO::PARAM_INT );
			$prepara->bindParam(16, $info['orcamento_yn'], PDO::PARAM_INT );
			$prepara->bindParam(17, $info['responsavel_balcao'], PDO::PARAM_INT );
			$prepara->bindParam(18, $info['cabo_forca_yn'], PDO::PARAM_INT );
			$prepara->bindParam(19, $info['cabo_video_yn'], PDO::PARAM_INT );
			$prepara->bindParam(20, $info['bandejas_yn'], PDO::PARAM_INT );
			$prepara->bindParam(21, $info['base_yn'], PDO::PARAM_INT );
			$prepara->bindParam(22, $info['toner_yn'], PDO::PARAM_INT );
			$prepara->bindParam(23, $info['cartucho_preto_yn'], PDO::PARAM_INT );
			$prepara->bindParam(24, $info['cartucho_color_yn'], PDO::PARAM_INT );
			$prepara->bindParam(25, $info['fonte_yn'], PDO::PARAM_INT );
			$prepara->bindParam(26, $info['drive_dvd_yn'], PDO::PARAM_INT );
			$prepara->bindParam(27, $info['pendrive_yn'], PDO::PARAM_INT );
			$prepara->bindParam(28, $info['case_yn'], PDO::PARAM_INT );
			$prepara->bindParam(29, $info['outro'], PDO::PARAM_INT );
			$prepara->bindParam(30, $info['defeito_rel'], PDO::PARAM_INT );
			$prepara->bindParam(31, $info['defeito_const'], PDO::PARAM_INT );
			$prepara->bindParam(32, $info['solucao'], PDO::PARAM_INT );
			$prepara->bindParam(33, $info['obs'], PDO::PARAM_INT );
	...
	function edita_ordem($pdo,$info){
		...
		try{
			...
			$prepara->bindParam(32, $info['solucao'], PDO::PARAM_INT );
			$prepara->bindParam(33, $info['obs'], PDO::PARAM_INT );
			$prepara->bindParam(34, $info['id'], PDO::PARAM_INT );
	...
	function aponta_transp($pdo,$info){
		...
		$insert->bindParam(13, $info['id'], PDO::PARAM_INT );
	...
	function del_xml_venda($pdo,$venda){
		...
		$select = $pdo->query("DELETE FROM tab_xml WHERE id_venda = '".$venda."' ");
	...
	function venda_periodo($pdo,$data1,$data2){
		...
		try{
			...
			WHERE 
					status_venda_nfe = 'fechada' 
				AND 
					(data_emis_nfe BETWEEN '".$data1."' AND '".$data1."')
		");
	...
	function produto($pdo){
		...
		$select = $pdo->query("SELECT * FROM tab_produto ");
		return $select->fetchAll();
	...
	function produto_codigo($pdo,$codigo){
		...
		$select = $pdo->query("SELECT * FROM tab_produto WHERE codigo_produto = ".$codigo." ");
		return $select->fetchAll();
		
	}
	
	//produtos por mais vendidos
	function produto_qtd($pdo,$codigo){
