  ...
  <body onLoad="initTimer();">
    ...
    <header>
      <h1 class="float-l">
		...
		-
		<span id="esconder">
			<a href="php/fecha_ordem.php?id=<?php echo $ordem[0]['id_ordem'] ?>" onclick="return confirm('Realmente deseja fechar a ordem?')" class="interno" style="font-size: 20pt">Fechar</a>
		</span>
      </h1>
	    				...
	    				<table id="titulo_form">
	    					...
	    					<tr>
	    						<td style="padding: 0px 5px;  height: 400px">
	    							...
	    							<br />
	    							Valor: R$ <input type="text" name="val_pg" value="<?php echo $ordem[0]['val_pg_ordem'] ?>" style="width: 150px; float: right" />
	    							<br />
	    							<br />
	    							Forma de Pagamento:
