    		...
    		<form action="php/edita_produto_mec.php" method="post">
	    		...
	    		<article id="cliente" class="grupo">
	    			...
	    			<div class="item">
	    				...
	    				<br />
	    				<input type="text" name="descricao" value="<?php echo $produto[0]['descricao_produto'] ?>" style="width: 346px; " />
	    			</div>
	    			<div class="item">
	    				<label class="item_titulo"for="codigo">Código: </label>
	    				<br />
		    			<input type="text" name="codigo" value="<?php echo $produto[0]['codigo_produto'] ?>" style="width: 200px; " />
		    		</div>
	    			<div class="item">
	    				<label class="item_titulo"for="ncm">NCM: </label>
	    				<br />
		    			<input type="text" name="ncm" value="<?php echo $produto[0]['ncm_produto'] ?>" style="width: 180px; " />
		    		</div>
		    		<div class="item">
		    			<label class="item_titulo"for="unid_com">Unid. Produto: </label>
		    			<br />
		    			<input type="text" name="unid" value="<?php echo $produto[0]['unid_produto'] ?>" style="width: 170px; " />
		    		</div>
		    		<div class="item">
		    			<label class="item_titulo"for="val_unid_com">Val. Produto: </label>
		    			<br />
		    			<input type="text" name="val" value="<?php echo $produto[0]['valor_produto'] ?>" style="width: 170px; " />
		    		</div>
    				<input type="hidden" name="classe_ipi" value="<?php echo $produto[0]['classe_ipi_produto'] ?>" style="width: 200px; " />
	    			<input type="hidden" name="cod_enquadr_ipi" value="<?php echo $produto[0]['cod_enquadramento_ipi_produto'] ?>" style="width: 220px; " />					
	    		</article>
