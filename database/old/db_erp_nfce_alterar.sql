...
--
-- Host: 127.0.0.1
-- Generation Time: 19-Dez-2016 às 14:21
...
INSERT INTO `tab_cliente` (`id_cliente`, `cpf_cnpj_cliente`, `estrangeiro_cliente`, `nome_razao_social_cliente`, `logradouro_cliente`, `numero_cliente`, `complemento_cliente`, `bairro_cliente`, `cod_municipio_cliente`, `municipio_cliente`, `uf_cliente`, `cep_cliente`, `cod_pais_cliente`, `pais_cliente`, `telefone_cliente`, `inscricao_estadual_cliente`, `inscricao_suframa_cliente`, `email_cliente`, `status_cliente`, `data_cadastro_cliente`, `isento_icms_cliente`, `banco_cliente`, `agencia_cliente`, `conta_cliente`, `nome_contato_cliente`, `telefone_contato_cliente`, `email_contato_cliente`) VALUES
(1, '11114284011106', '', 'CASA & VIDEO RIO DE JANEIRO S/A', 'Estrada do CamboatÃ¡', '000', '', 'Meu Ranchinho', '3304144', 'Queimados', '33', '26379160', '1058', 'Brasil', '2145678945', '86600986', '', 'teste@mail.com', 'ativo', '2016-12-19 08:19:31', 'sim', '', '', '', '', '', '');
...
(1, 2, 425, 0, 55, 'ERDUS COMERCIO E EQUIPAMENTOS INSDUSTRIAIS LTDA', 'ERDUS', 'assets/images/logo.png', '03522429000137', '76129878', '1234687', '029637', '1231654', '1', 'Rua DindorÃ¡ Silva', '592', '', 'Jardim Meriti', '25555501', 'Brasil', '55', 'RJ', 'SÃ£o JoÃ£o de Meriti', '3305109', '2137553971', '0.65', '3.00');
...
--
-- Extraindo dados da tabela `tab_item_nfe`
--

INSERT INTO `tab_item_nfe` (`id_item`, `id_produto`, `id_nfe`, `qtd_item`, `val_unit`, `val_total`, `ind_total_item`, `cfop_item`, `sit_trib_icms`, `origem_icms`, `base_calc_icms`, `aliq_calc_cred_icms`, `cred_icms`, `modbc_icms`, `p_reducao_bc_icms`, `vbc_icms`, `aliq_icms`, `val_op_icms`, `modbcst_icms`, `p_reducao_bcst_icms`, `p_m_vast_icms`, `vbcst_icms`, `aliq_st_icms`, `val_st_icms`, `vbc_ret_ant_st_icms`, `v_ret_ant_st_icms`) VALUES
(1, 5, 1, 1, '6.00', '6.00', 1, 5102, 102, 0, '6.00', '0.0000', '0.00', 0, '0.0000', '0.00', '0.0000', '0.00', 0, '0.0000', '0.0000', '0.00', '0.0000', '0.00', '0.00', '0.00');
...
CREATE TABLE `tab_nfe` (
  ...
  `tipo_documento_nfe` int(11) DEFAULT NULL,
  `destino_operacao_nfe` int(11) DEFAULT NULL,
  `cod_municipio_ocorrencia_nfe` varchar(7) DEFAULT '3305109',
  `nfref_nfe` text NOT NULL,
  `formato_danfe_nfe` int(11) NOT NULL,
  `forma_emissao_nfe` int(11) DEFAULT NULL,
  `cod_dv_nfe` int(11) NOT NULL,
  `ambiente_nfe` int(11) NOT NULL,
  `finalidade_emissao_nfe` int(11) DEFAULT NULL,
  `comprador_final_nfe` int(11) NOT NULL,
  `presenca_comprador_nfe` int(11) NOT NULL,
  `procemi_nfe` int(11) NOT NULL,
  `verproc_nfe` varchar(20) NOT NULL,
  `status_venda_nfe` varchar(50) NOT NULL,
  `val_total_nfe` decimal(6,2) NOT NULL,
  `id_transp_nfe` int(11) NOT NULL,
  `mod_frete` tinyint(1) DEFAULT NULL,
...
CREATE TABLE `tab_ordem` (
  ...
  `cpf_cnpj_cliente_ordem` varchar(100) NOT NULL,
...
(5, '1234', 'Porta PreÃ§os Modelo Seral Antigo', '39162000', 'PÃ‡', '6.0000000000', '0.00', 0, 0, '999', '999'),
(6, '4321', 'Porta PreÃ§os Modelo NSF Antigo', '39162000', '', '6.0000000000', '0.00', 0, 0, '999', '999');
...
(3, 'TRANSPOSTADORA EXEMPLAR', '04765325000116', '281172005', NULL, 'Rua MercÃºrio', '000', 'vila 00', 'Pavuna', '21532470', 'Brasil', 'RJ', 'Rio de Janeiro', '3304557', '2198657845');
...
--
ALTER TABLE `tab_nfe`
  MODIFY `id_nfe` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
...
--
ALTER TABLE `tab_transportadora`
  MODIFY `id_transportadora` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT for table `tab_xml`
--
ALTER TABLE `tab_xml`
  MODIFY `id_xml` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
