...
("7900","OUTRAS SAIDAS DE MERCADORIA OU PRESTAÇÕES DE SERVIÇOS",""),
...
CREATE TABLE `tab_emitente` (
  `id_emitente` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO tab_emitente VALUES
("1","2","0","0","55","","","imgs/logosinfe.png\n","","","","","","1","","","","","","Brasil","55","RJ","","","","0.00","0.00");
...
CREATE TABLE `tab_nref` (
  `id_nref` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `tab_produto` (
  ...
  `ean_produto` varchar(100) DEFAULT NULL,
...
("184","446","Disco Norton Desbaste 4 1/2 aaaaaaaaaaaaaaaa","82023100","PÃ‡","4.1000000000","0.00","0","0","",""),
...
("207","2121","teste","24578963","pc","20.0000000000","0.00","0","0","999","999");




CREATE TABLE `tab_produto_nota` (
  `id_produto_nota` int(11) NOT NULL AUTO_INCREMENT,
  `id_nfe` int(11) NOT NULL,
  `id_produto` int(11) NOT NULL,
...
CREATE TABLE `tab_transportadora` (
  ...
  KEY `id_transportadora_2` (`id_transportadora`),
  KEY `id_transportadora_3` (`id_transportadora`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1;
...
CREATE TABLE `tab_cce` (
  `id_cce` int(11) NOT NULL AUTO_INCREMENT,
  `id_venda` int(11) NOT NULL,
