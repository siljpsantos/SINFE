...
--
-- Host: 127.0.0.1
-- Generation Time: 29-Set-2016 às 15:34
...
INSERT INTO `tab_estados` (`codigo_ibge`, `uf`, `nome`) VALUES
(11, 'RO', 'Rondônia'),
(12, 'AC', 'Acre'),
(13, 'AM', 'Amazonas'),
(14, 'RR', 'Roraima'),
...
INSERT INTO `tab_municipios` (`id`, `iduf`, `nome`) VALUES
...
--
-- Indexes for table `tab_estados`
--
ALTER TABLE `tab_estados`
  ADD PRIMARY KEY (`codigo_ibge`);

--
-- Indexes for table `tab_municipios`
--
